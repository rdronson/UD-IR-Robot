...
#define IR_R 8 //7 2
#define IR_L 9 //8 6
#define IR_TOP 10 //Top IR LED 9 8
#define TIMER 500000
...
void loop()
{
    ...
    if(digitalRead(IR_F) == LOW and currentState0 == 1)
    {
    ...
    if(digitalRead(IR_FR) == LOW and currentState1 == 1)
    {
    ...
    if(digitalRead(IR_R) == LOW and currentState2 == 1)
    {
    ...
    if(digitalRead(IR_BR) == LOW and currentState3 == 1)
    {
    ...
    if(digitalRead(IR_B) == LOW and currentState4 == 1)
    {
    ...
    if(digitalRead(IR_BL) == LOW and currentState5 == 1)
    {
    ...
    if(digitalRead(IR_L) == LOW and currentState6 == 1)
    {
    ...
    if(digitalRead(IR_FL) == LOW and currentState7 == 1)
    {
...
int findCenter(unsigned short detect){
  if(detect == 6){
    if((sensorArray[0] == 1 )and (sensorArray[1] == 1)and (sensorArray[2] == 1 )and (sensorArray[3] == 0) and (sensorArray[4] == 0 )and (sensorArray[5] == 1)and (sensorArray[6] == 1) and (sensorArray[7] == 1)){
      ...
      return 3; //BACK RIGHT; Turn 135 degrees to the right then Drive forward
    }
      ...
      return 4; //BACK; Turn 180 degrees to the right or left then Drive forward
    }
      ...
      return 5; //BACK LEFT; Turn 135 degrees to the left then Drive forward
    }
    ...
    if((sensorArray[0] == 1 )and (sensorArray[1] == 1)and (sensorArray[2] == 1)and (sensorArray[3] == 0) and (sensorArray[4] == 0) and (sensorArray[5] == 0)and (sensorArray[6] == 1) and (sensorArray[7] == 1)){ 
      ...
      // FR, R, BR, B, BL
      return 3; //BACK RIGHT, Turn wheels 135 degrees to right and straighten wheels
      ...
      // R, BR,B, BL, L
      return 4;//BACK, Turn 180 degrees around and straighten wheels
      ...
      // BR, B, BL, L, FL
      return 5; //BACK LEFT, Turn wheels 135 degrees to left and straighten wheels
    ...
    if((sensorArray[0] == 1) and (sensorArray[1] == 1) and (sensorArray[7] == 1)){ // FR, F, FL
      return 0; //FRONT, Drive Straight ahead
      
    }
    else if((sensorArray[0] == 1) and (sensorArray[1] == 1) and (sensorArray[2] == 1)){ // R, FR, F
      return 1; //FRONT RIGHT, Turn wheels 45 degrees to the right and then straighten wheels
    
    }
    else if((sensorArray[1] == 1) and (sensorArray[2] == 1) and (sensorArray[3] == 1)){ // FR, R, BR
      return 2; //RIGHT, Turn wheels 90 degrees to the right and then straighten wheels
    
    }
    else if((sensorArray[2] == 1) and (sensorArray[3] == 1) and (sensorArray[4] == 1)){ // R, BR, B
      return 3; //BACK RIGHT, Turn wheels 135 degrees to the right and then straighten wheels
    
    }
    else if((sensorArray[3] == 1) and (sensorArray[4] == 1) and (sensorArray[5] == 1)){ // BR, B, BL
      return 4; //BACK, Turn around 180 degrees to right or left and then straighten wheels
    
    }
    else if((sensorArray[4] == 1) and (sensorArray[5] == 1) and (sensorArray[6] == 1)){ // B, BL, L
      return 5; //BACK LEFT, Turn around 135 degrees to left and then straighten wheels
    
    }
    else if((sensorArray[5] == 1) and (sensorArray[6] == 1) and (sensorArray[7] == 1)){ // BL, L, FL
      return 6; //LEFT, Turn around 90 degrees to left and then straighten wheels
    
    }
    else if((sensorArray[6] == 1) and (sensorArray[7] == 1) and (sensorArray[0] == 1)){ // L, FL, F
...
void doAction(int sensor){
  if(sensor == 0){
    ...
    Serial.println("Steering Right 45 degrees then driving after wheels are straight");
  }
  else if(sensor == 2){
    //steer wheels to right 90 degrees and starighten wheels then drive forward
    Serial.println("Steering Right 90 degrees then driving after wheels are straight");
  }
  else if(sensor == 3){
    //steer wheels to right 135 degrees and starighten wheels then drive forward
    Serial.println("Steering Right 135 degrees then driving after wheels are straight");
  }
  else if(sensor == 4){
    //steer wheels to right or left 180 degrees and starighten wheels then drive forward
    Serial.println("Steering Right or Left 180 degrees then driving after wheels are straight");
  }
  else if(sensor == 5){
    //steer wheels to left 135 degrees and starighten wheels then drive 
    Serial.println("Steering Left 135 degrees then driving after wheels are straight");
    
  }
  else if(sensor == 6){
    //steer wheels to left 90 degrees and starighten wheels then drive forward
    Serial.println("Steering Left 90 degrees then driving after wheels are straight");
  }
  else if(sensor == 7){
    //steer wheels to left 45 degrees and starighten wheels then drive forward
    Serial.println("Steering Left 45 degrees then driving after wheels are straight");
  }
}
