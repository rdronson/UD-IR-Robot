...
#define REAR 9  //Rear Steering
#define FRONT 10 //Front Steering
#define SC 11 //Speed Control
#define TIMER 250000
...
int findCenter(unsigned short detect){
  if(detect == 6){
    ...
    if((sensorArray[0] == 1 )and (sensorArray[1] == 1)and (sensorArray[2] == 0)and (sensorArray[3] == 0) and (sensorArray[4] == 0)and (sensorArray[5] == 0)and (sensorArray[6] == 0) and (sensorArray[7] == 0)){ // FR, F 0 1 
      return 0; //FRONT, Drive Straight ahead
      
    }
    else if((sensorArray[0] == 0)and (sensorArray[1] == 1)and (sensorArray[2] == 1)and (sensorArray[3] == 0) and (sensorArray[4] == 0)and (sensorArray[5] == 0)and (sensorArray[6] == 0) and (sensorArray[7] == 0)){ // R, FR  1 2
      return 1; //FRONT RIGHT, Turn wheels 45 degrees to the right and then straighten wheels
    
    }
    else if((sensorArray[0] == 0)and (sensorArray[1] == 0)and (sensorArray[2] == 1)and (sensorArray[3] == 1) and (sensorArray[4] == 0)and (sensorArray[5] == 0)and (sensorArray[6] == 0) and (sensorArray[7] == 0)){ // R, BR 2 3
      return 2; //RIGHT, Turn wheels 90 degrees to the right and then straighten wheels
    
    }
    else if((sensorArray[0] == 0)and (sensorArray[1] == 0)and (sensorArray[2] == 0)and (sensorArray[3] == 1) and (sensorArray[4] == 1)and (sensorArray[5] == 0)and (sensorArray[6] == 0) and (sensorArray[7] == 0)){ //BR, B 3 4
      return 3; //REAR RIGHT, Turn wheels 135 degrees to the right and then straighten wheels
    
    }
    else if((sensorArray[0] == 0)and (sensorArray[1] == 0)and (sensorArray[2] == 0)and (sensorArray[3] == 0) and (sensorArray[4] == 1)and (sensorArray[5] == 1)and (sensorArray[6] == 0) and (sensorArray[7] == 0)){ // B, BL 4 5
      return 4; //REAR, Turn around 180 degrees to right or left and then straighten wheels
    
    }
    else if((sensorArray[0] == 0)and (sensorArray[1] == 0)and (sensorArray[2] == 0)and (sensorArray[3] == 0) and (sensorArray[4] == 0)and (sensorArray[5] == 1)and (sensorArray[6] == 1) and (sensorArray[7] == 0)){ //BL, L 5 6
      return 5; //REAR LEFT, Turn around 135 degrees to left and then straighten wheels
    
    }
    else if((sensorArray[0] == 0)and (sensorArray[1] == 0)and (sensorArray[2] == 0)and (sensorArray[3] == 0) and (sensorArray[4] == 0)and (sensorArray[5] == 0)and (sensorArray[6] == 1) and (sensorArray[7] == 1)){ //L, FL 6 7
      return 6; //LEFT, Turn around 90 degrees to left and then straighten wheels
    
    }
    else if((sensorArray[0] == 1)and (sensorArray[1] == 0)and (sensorArray[2] == 0)and (sensorArray[3] == 0) and (sensorArray[4] == 0)and (sensorArray[5] == 0)and (sensorArray[6] == 0) and (sensorArray[7] == 1)){ // FL, F 7 0
      return 7; //FRONT LEFT, Turn around 45 degrees to left and then straighten wheels
...
void doAction(int sensor){  
  if(sensor == 0){
    ...
    delayMicroseconds(1700); ///changed from 1700 to 1000
    digitalWrite(SC, LOW);
    ...
    //steer rear wheels straight ahead
    digitalWrite(FRONT, HIGH);
    delayMicroseconds(1600);    
    digitalWrite(FRONT, LOW);
